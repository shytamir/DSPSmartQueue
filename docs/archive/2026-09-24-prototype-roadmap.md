# Prototype delivery roadmap (archived 2026-09-24)

Historical work definitions retained after delivery and publication closeout.
This archive does not activate work; use the [planning placeholder](../management/ROADMAP.md)
and authoritative [PROJECT.md](../PROJECT.md) for current steering.
